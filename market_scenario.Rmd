...
After the first month of the study, researchers will design a template to graph and analyze the data based on the data structure and consistency. At the end of the experimental period, data will be visualized, analyzed, and presented.
